...
1. **get-menu** - Provides the complete coffee shop menu including drinks and food items with their descriptions, prices, 
categories, tags, and available add-ons.

2. **list-order** - Returns a list of all current orders in the system, showing customer names, order contents, and total price.

3. **take-order** - Allows taking new orders by specifying a customer name and a list of menu items they want to order.
