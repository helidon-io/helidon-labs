...
/**
 * {@link io.helidon.labs.apps.data.se.declarative.model.Owner} entity data repository interface.
 * <p>
 * {@code OwnerRepository} interface acts as a data access layer, encapsulating the logic for interacting
 * with the {@link io.helidon.labs.apps.data.se.declarative.model.Owner} entity data.
 *
 * @see io.helidon.labs.apps.data.se.declarative.model.Owner
 */
@Data.Repository
