...
/**
 * Service class responsible for handling HTTP requests related to {@link io.helidon.labs.apps.data.se.declarative.model.Pet} entities.
 * <p>
 * This class provides endpoint handlers for operations on {@link io.helidon.labs.apps.data.se.declarative.model.Pet} entities.
 *
 * @see PetRepository
 * @see BreedRepository
 * @see OwnerRepository
...
class PetService {
    ...
    /**
     * Handles the {@code GET /all} request and returns a list of all {@link io.helidon.labs.apps.data.se.declarative.model.Pet} entities.
     *
     * @return the list of all {@link io.helidon.labs.apps.data.se.declarative.model.Pet} entities
     */
    @Http.GET
    @Http.Path("/all")
