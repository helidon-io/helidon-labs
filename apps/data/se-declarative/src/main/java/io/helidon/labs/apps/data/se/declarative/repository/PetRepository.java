...
/**
 * {@link io.helidon.labs.apps.data.se.declarative.model.Pet} entity data repository interface.
 * <p>
 * {@code PetRepository} interface acts as a data access layer, encapsulating the logic for interacting
 * with the {@link io.helidon.labs.apps.data.se.declarative.model.Pet} entity data, and also provides basic CRUD (Create, Read, Update, Delete) operations
 * for the {@link io.helidon.labs.apps.data.se.declarative.model.Pet} entity.
 *
 * @see io.helidon.data.Data.CrudRepository
 * @see io.helidon.labs.apps.data.se.declarative.model.Pet
 */
@Data.Repository
