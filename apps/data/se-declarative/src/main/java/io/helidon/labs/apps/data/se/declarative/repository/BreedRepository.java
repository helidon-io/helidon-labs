...
/**
 * {@link io.helidon.labs.apps.data.se.declarative.model.Breed} entity data repository interface.
 * <p>
 * <p>
 * This interface acts as a data access layer, encapsulating the logic for interacting
 * with the {@link io.helidon.labs.apps.data.se.declarative.model.Breed} entity data.
 *
 * @see io.helidon.labs.apps.data.se.declarative.model.Breed
 */
@Data.Repository
