...
/**
 * Service class responsible for handling HTTP requests related to {@link io.helidon.labs.apps.data.se.declarative.model.Breed} entities.
 * <p>
 * This class provides endpoint handlers for operations on {@link io.helidon.labs.apps.data.se.declarative.model.Breed} entities.
 *
 * @see BreedRepository
 */
...
class BreedService {
    ...
    /**
     * Handles the {@code GET /all} request and returns a list of all {@link io.helidon.labs.apps.data.se.declarative.model.Breed} entities.
     *
     * @return the list of all {@link io.helidon.labs.apps.data.se.declarative.model.Breed} entities
     */
    @Http.GET
    @Http.Path("/all")
