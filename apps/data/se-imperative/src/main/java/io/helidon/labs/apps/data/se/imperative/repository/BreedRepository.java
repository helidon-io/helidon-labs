...
/**
 * {@link io.helidon.labs.apps.data.se.imperative.model.Breed} entity data repository interface.
 * <p>
 * <p>
 * This interface acts as a data access layer, encapsulating the logic for interacting
 * with the {@link io.helidon.labs.apps.data.se.imperative.model.Breed} entity data.
 *
 * @see io.helidon.labs.apps.data.se.imperative.model.Breed
 */
@Data.Repository
